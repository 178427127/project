        ...
        <div class="quick-pay-wrap">
          ...
          <form id="form" name="form" method="post" action="" >
            <div class="quick-main">
              <div class="fl quick-info">
                ...
                <div class="info-tips">民信金融提醒您：充值金额超过50000元时，请切换到网银充值</div>
                ...
                <div class="bank-check" id="bank-check2"> <b class="selected" id="bankProtocol1"></b><span class="bank-agree">我同意并接受<a href="#" target="_blank">《民信金融投资咨询与管理服务电子协议》</a></span> <span class="error" id="bankProtocol_message" style="display:none;margin-top:-3px;">请同意协议内容！</span> </div>
          ...
          <div class="online-main" style="display:none;">
            <form id="recharge" name="recharge" method="post" action="#" target="_blank">
              ...
              <div> <span><font style=" color:#848484;font-weight:bold; margin-left:80px; height:32px; line-height:32px; font-size:12px;">民信金融提醒您：充值前，请核实您的可用支付额度！</font></span> </div>
              ...
              <div class="bank-check" id="bank-check"> <b class="selected" id="bankProtocol"></b><span class="bank-agree">我同意并接受<a href="/node/Candyprivacypolicy/candyprivacypolicy_tzzxyglfwdzxy" target="_blank">《民信金融金融投资咨询与管理服务电子协议》</a></span> <span class="error" id="bankProtocol_message" style="display:none;margin-top:-3px;">请同意协议内容！</span> </div>
