...
<div id="personal-left" class="personal-left">
      <ul>
        ...
        <li><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;" href="<%=basePath %>moneyrecord.jsp"> 资金记录</a></span></li>
        ...
        <li><span><a style="font-size:14px;text-align:center;width:115px;padding-right:35px;" href="<%=basePath %>huikuanmoneyrecord.jsp">回款计划</a></span></li>
