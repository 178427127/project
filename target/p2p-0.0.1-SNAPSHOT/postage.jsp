    ...
    <div class="text-box">
		<div class="text-content" id="text-content">
				...
				<p class="mt10 cn_line">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. 民信金融郑重承诺：如投资者未能获得利息，民信金融将启动“赔付宝”本息安全保障计划，按照《“赔付宝”资金使用规则》对投资者的本金及利息进行垫付，除居间服务费外，网站不向投资人收取其他费用。
				</p>
				<p>
					<br>
				</p>
				<p class="mt10 cn_line">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. 提现费用：民信金融不向平台会员收取任何提现费用，仅代为收取第三方平台（环迅支付）应缴纳的提现费用。 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;普通会员提现时按照额度，每笔收取提现金额的千分之三（0.3%），上不封顶。 <br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#e53333;">民信金融VIP会员缴纳年费后，将免费提现</span>，由民信金融支付应向第三方平台（环迅支付）缴纳的提现费用。
				</p>
				<p>
					<br>
				</p>
				<p class="mt10 cn_line">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. 凡是在民信金融平台注册的用户，自动成为民信金融普通会员，<span style="color:#e53333;">普通会员免会员费。</span><br>
