		...
		<section class="wrapper">
			...
			<div class="showback">
				...
				<form class="form-horizontal style-form" method="post"
					...
					<div class="form-group">
						<label class="col-sm-2  control-label">员工身份证号码：</label>
						<div class="col-sm-4">
							<input type="text" class="form-control"
					...
					<div class="form-group">
						...
						<label class="col-sm-2  control-label">显示</label> <span>
							<button type="reset" class="col-sm-2 control-label">重置</button>
						</span>
					</div>
