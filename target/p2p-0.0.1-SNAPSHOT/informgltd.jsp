...
<!--左导航栏--><jsp:include page="my_ue.jsp"></jsp:include>
    ...
    <div class="text-box">
			<div class="text-content" id="text-content">
				...
				民信金融以金融创新基因吸引了来自国内五百强知名企业的业界精英，目前团队成员年轻朝气、充满活力，热爱新事物，勇于接受新挑战，团队成员有信心和决心，要用人人共享的理念在金融改革的浪潮中乘风破浪，要为普通大众创造财富增值的机会，为诚信经营者提供高效便捷的金融服务。
				</p>
...
<%--						<img src="<%=request.getContextPath()%>${list.noticepicture }" height="160px" width="120px">--%>
					</div>
				...
				<p>
					<img src="<%=basePath%>images/org.png" alt="民信金融-组织机构" title="民信金融-组织机构">
				</p>
			</div>
		</div>
